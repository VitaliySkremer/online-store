...
export const DeviceItem = ({device}:DeviceProps) => {
  ...
  return (
    <Col md={3} className="mt-3"
         onClick={()=> navigate(`${ERouter.DEVICE_ROUTER}/${device.id}`)}>
      <Card
        style={{cursor:'pointer', width:150}}
        border={"light"}
      >
        <Image src={process.env.REACT_APP_API_URL+'/'+device.img} width={150} height={150} className="mb-1"/>
